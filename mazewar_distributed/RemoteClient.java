...
public class RemoteClient extends Client {
        ...
        public RemoteClient(String name, int x, int y, int orientation) {
            super(name,x ,y, orientation);
    }
        
        public RemoteClient(String name, int x, int y, int orientation, String hostname, int port) {
            super(name,x ,y, orientation, hostname, port);
    }
}
