...
public abstract class Client {
        ...
        public Queue<InstructionPacket> actions = null;
        ...
        protected Client(String name, ObjectOutputStream out, Queue<InstructionPacket> actions, String hostname, int port) {
        ...
        protected Client(String name, int x, int y, int orientation) {
			// TODO Auto-generated constructor stub
        	assert(name != null);
        	this.name = name;
        	this.x = x;
        ...
        protected Client(String name, int x, int y, int orientation, String hostname, int port) {
			// TODO Auto-generated constructor stub
        	assert(name != null);
        ...
        private void notifyListeners(ClientEvent ce) {
                ...
                while (i.hasNext()) {
						...
						System.out.println(ce.toString()); //debug
